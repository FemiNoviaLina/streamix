<x-base-layout>
    <x-base-body>
        @if(count($sharingGroups) == 0)
        <div class="flex content-center justify-center my-10">
            <p>Tidak ada data untuk ditampilkan</p>
        </div>
        @else
        <div id="sharingGroups" class="m-10">
            <div id="stats" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                <a class="bg-gray-200 rounded-lg" href="#">
                    <div class="p-5">
                        <p class="text-xl font-bold bg-white rounded-lg text-center">Rp 30.000/bulan</p>
                    </div>
                    <div class="inline-flex">
                        <div>
                            <div class="px-5">
                                <p class="font-medium">Paket Family Dasar</p>
                            </div>
